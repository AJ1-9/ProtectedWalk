...
import b.daichimizuno.protectedwalkphone.camera.CameraSourcePreview;
import b.daichimizuno.protectedwalkphone.camera.GraphicOverlay;

import static b.daichimizuno.protectedwalkphone.acceleration.AccelerationActivity.*;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       if (gender == 1) {
           ImageView imageView_man = findViewById(R.id.image_gender);
           imageView_man.setImageResource(R.drawable.walker_man);
       }
       if(gender == 2){
           ImageView imageView_woman = findViewById(R.id.image_gender);
           imageView_woman.setImageResource(R.drawable.walker_woman);
       }

       // 年齢画面に表示
       TextView text = findViewById(R.id.text_age);
       age = intent.getIntExtra("human_age", 0);
       String s = String.valueOf(age);
       text.setText("Age:"+ s);

       button = findViewById(R.id.button_control2);
       mStartButton = findViewById(R.id.button_start);
       button.setOnClickListener(this);
       mStartButton.setOnClickListener(this);

       Log.d("UserSet", "性別" + gender + "年齢" + age);
